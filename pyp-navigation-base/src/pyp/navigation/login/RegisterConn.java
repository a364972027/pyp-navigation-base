...
public class RegisterConn {
	...
	private final static String url_constant = "http://10.0.2.2:8080/JsonWeb/register.action?";
	 ...
	 * @param password
	 */
	public static void RegisterRemoteService(String userName, String password) {
		result = null;
		try {
